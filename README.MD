...
The following virtual CHS table is used when in LBA mode. It is analog
to what BIOS uses when performing assisted LBA. The virtual cylinder in
LBA mode may be larger than 1023. 
